...
public class Calculation {
    ...
    String solveEquation(){
        ...
        for(int i=0;i<length;i++){
            ...
            if(curChar=='('||curChar=='+'||curChar=='-'||curChar=='X'||curChar=='÷'||curChar=='%'||curChar=='^'){
                ...
                if(curChar=='(')  {
                    ...
                    if (!stack.empty()){
                        while (true) {
                            if (stack.peek().equals("X") || stack.peek().equals("÷") || stack.peek().equals("%") || stack.peek().equals("^")) {
                                queue[count++] = stack.pop();
                            }else{
                                break;
                            }
                ...
                for(i++;i<length;i++)
                {
                    ...
                    if(curBackChar==')'||curBackChar=='+'||curBackChar=='-'||curBackChar=='X'||curBackChar=='÷'||curBackChar=='%'||curBackChar=='^'){
                        i--;
                        break;
                    }
                    else
        ...
        for(int i=0;i<count;i++){
            ...
            if(member.equals("+")||member.equals("-")||member.equals("X")||member.equals("÷")||member.equals("%")||member.equals("^")){
...
//                    处理  x^(-1)的情况
                ...
                if (member.equals("X")) first *= second;
                if (member.equals("÷")) first /= second;
                if (member.equals("%")) first %= second;
                if (member.equals("^")){
                    double sum = 1;
